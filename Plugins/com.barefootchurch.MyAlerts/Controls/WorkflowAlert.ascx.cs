    ...
    public partial class WorkflowAlert : Rock.Web.UI.RockBlock
    {
        ...
        protected void activeWorkflowCount()
        {
            ...
            if ( CurrentPersonAliasId.HasValue )
            {
                ...
                string cacheKey = "MyAlerts:WorkflowCount:PersonAliasId:" + CurrentPersonAliasId.ToString();
                ...
                lbWorkflowListingPage.Controls.Add( new LiteralControl( spanLiteral ) );
            }
        }
        ...
        /// </summary>
        protected void lbWorkflowListingPage_Click( object sender, EventArgs e )
        {
